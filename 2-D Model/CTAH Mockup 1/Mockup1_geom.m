...
tubes_vol=20; %Number of tubes in finite volume
N_T=20; %Number of rows in transversal direction per volume cell
N_L=1; %Number of rows in longitudinal direction per volume cell
...
L=2*pi*R_curv/108; %Length of control volume in direction of coolant flow for 50 rows [m]
