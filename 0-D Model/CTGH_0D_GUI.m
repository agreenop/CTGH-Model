function varargout = CTGH_0D_GUI(varargin)
% CTGH_0D_GUI MATLAB code for CTGH_0D_GUI.fig
%      CTGH_0D_GUI, by itself, creates a new CTGH_0D_GUI or raises the existing
%      singleton*.
%
%      H = CTGH_0D_GUI returns the handle to a new CTGH_0D_GUI or the handle to
%      the existing singleton*.
%
%      CTGH_0D_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CTGH_0D_GUI.M with the given input arguments.
%
%      CTGH_0D_GUI('Property','Value',...) creates a new CTGH_0D_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CTGH_0D_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CTGH_0D_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CTGH_0D_GUI
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @CTGH_0D_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @CTGH_0D_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CTGH_0D_GUI is made visible.
function CTGH_0D_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CTGH_0D_GUI (see VARARGIN)

% Choose default command line output for CTGH_0D_GUI
handles.output = hObject;
handles.Cancel_program='Cancel';
% Update handles structure
guidata(hObject, handles);

% UIWAIT makes CTGH_0D_GUI wait for user response (see UIRESUME)
uiwait(hObject);


% --- Outputs from this function are returned to the command line.
function varargout = CTGH_0D_GUI_OutputFcn(hObject, eventdata, handles) 
