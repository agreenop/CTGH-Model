...
save(fname2,'tubes','D_curve_outer','H_bank','Area_surf','v_g_max','Re_g','U','A_ideal','F','deltaP_g','deltaP_l');
range_output=sprintf('G%d:Q%d',i+1,i+1);
B=[tubes,D_curve_outer,H_bank,Area_surf,v_g_max,Re_g,U,A_ideal,F,deltaP_g,deltaP_l];
xlswrite('Optimization_Files/Optimization_Results.xlsx',B,range_output);
% csvwrite('Optimization_Files/Optimization_Results.csv',B,i,6);